...
type Templates struct {
	...
	AppointmentBookedByDoctor string // TWILIO_TEMPLATE_APPOINTMENT_BOOKED_BY_DOCTOR
...
func LoadTemplatesFromEnv() Templates {
	return Templates{
		...
		AppointmentBookedByDoctor: os.Getenv("TWILIO_TEMPLATE_APPOINTMENT_BOOKED_BY_DOCTOR"),

...
func SetupTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(
		...
		&models.AuditLog{}, &models.AppointmentNoteHistory{}, &models.Cie10Code{}, &models.ConsentRecord{},
		&models.Referral{}, &models.ClinicEmailInvite{}, &models.WhatsAppMessage{},
	); err != nil {
	...
	if err := db.Exec(
		"TRUNCATE TABLE doctor_patients, medical_documents, appointments, medical_histories, patients, doctor_templates, doctor_schedules, doctor_gallery_images, reviews, doctor_staff, staffs, doctors, super_admins, push_subscriptions, clinics, audit_logs, appointment_note_histories, consent_records, referrals, clinic_email_invites, whatsapp_messages RESTART IDENTITY CASCADE",
	).Error; err != nil {
